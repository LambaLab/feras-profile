...
export const profileHumain: Profile = {
  ...
  about: `Saudi Arabia is building one of the world's most ambitious AI markets. The companies that win won't just have the best models. They'll have the commercial infrastructure to deploy AI at scale across Travel, Entertainment, and Retail.

That's the intersection where I work.

I hold an M.Sc. in Artificial Intelligence from KFUPM and have spent 18 years as a CCO, CRO, and COO. I'm one of the few executives in the GCC who combines formal AI credentials with a track record of building and running commercial organisations at scale. I don't just advise on AI strategy. I deploy it and own the P&L it affects.

At FlyAkeed, Saudi Arabia's leading corporate travel management platform, I'm building the commercial AI engine: AI SDR, lead generation automation, and intelligent spend management that's changing how corporations across the Kingdom manage business travel.

At Zid, I scaled Saudi Arabia's leading e-commerce platform to 12,000+ merchants across retail, entertainment, F&B, and consumer services, driving 3B SAR in cumulative GMV. Before Zid, I was SVP at Tihama Group, one of Saudi Arabia's largest media and entertainment conglomerates.

Specialties: AI-Powered Commercial Growth | Travel Tech | Entertainment & Retail GTM | Revenue Architecture | Go-to-Market Strategy | P&L Management | Saudi Vision 2030 | GCC Markets`,
...
Pioneered an AI-powered commercial engine, deploying AI SDR and AI-driven lead generation and nurturing workflows that significantly accelerated pipeline velocity and reduced cost of acquisition across the corporate travel market.
...
Won 30+ high-value enterprise key accounts away from entrenched competitors by personally driving the strategy to identify, pursue, and convert enterprise merchants and expand Zid's market share in competitive segments.`,
      }
    }
...
When we got the architecture right, with enriched lead data, precise AI-to-human handoffs, and full CRM integration, pipeline velocity increased significantly and cost of acquisition dropped.
...
At Zid, I watched this shift happen in real time. We powered thousands of entertainment, F&B, and consumer merchants. The ones who pulled ahead were not the ones with the best product. They were the ones who understood their customer data and built commercial systems around it.
