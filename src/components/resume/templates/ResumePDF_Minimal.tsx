...
interface ResumePDF_MinimalProps { profile: Profile }

const styles = StyleSheet.create({
  page: { paddingTop: 48, paddingBottom: 48, paddingHorizontal: 52, fontFamily: 'Helvetica', fontSize: 10, color: BLACK, lineHeight: 1.4 },
  name: { fontSize: 22, fontFamily: 'Helvetica-Bold', marginBottom: 8 },
  headline: { fontSize: 10.5, color: GRAY, marginBottom: 6 },
  metaRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, fontSize: 9, color: LIGHT, marginBottom: 2 },
  metaLink: { color: BLACK, fontSize: 9, textDecoration: 'none' },
  metaDot: { color: LIGHT, fontSize: 9 },
  section: { marginTop: 14 },
  sectionRule: { borderBottomWidth: 1, borderBottomColor: RULE, marginBottom: 5 },
  sectionLabel: { fontSize: 8, color: BLACK, fontFamily: 'Helvetica-Bold', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 5 },
  ...
  expBulletDot: { fontSize: 9, color: BLACK, width: 14 },
...
export function ResumePDF_Minimal({ profile }: ResumePDF_MinimalProps) {
  const allSkills = [
